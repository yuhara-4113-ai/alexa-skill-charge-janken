...
- **溜め（チャージ）**: パワーを1増やす
- **攻撃**: パワーを1消費する威力1の攻撃
- **ファイアー**: パワーを2消費する威力2の攻撃
- **ブラックホール**: パワーを3消費する威力3の攻撃。防御を貫通する
- **防御**: パワーを消費せず、攻撃とファイアーを防ぐ

攻撃系の行動はすべて溜めに勝ち、攻撃系同士では威力が高い方が勝ちます。同じ威力なら勝敗なしで続行します。防御は攻撃とファイアーを防ぎますが、ブラックホールには貫通されます。それ以外の組み合わせも勝敗なしで次のラウンドへ進みます。
...
2. Alexa「チャージじゃんけんへようこそ。溜め、攻撃、ファイアー、ブラックホール、防御のどれかを言ってね。せーの。」
...
Alexaは自分の行動を「チャージ」「ビーム」「ファイアー」「ブラックホール」「バリアー」と読み上げます。
